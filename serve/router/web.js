...
module.exports = (app) => {
  ...
  // 英雄列表数据
  web.get('/hero/list', require('./web/heroList'));

  // 文章详情数据
  web.get('/news/details/:id', require('./web/newsDetails'));

  // 英雄详情数据
  web.get('/hero/details/:id', require('./web/heroDetails'));
